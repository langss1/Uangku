...
extension ThemeColors on BuildContext {
  ...
  Color get scaffoldBackgroundColor => isDarkMode ? const Color(0xFF121212) : AppColors.background;
  Color get textPrimary => isDarkMode ? Colors.white : AppColors.textDark;
  ...
  Color get cardColor70 => isDarkMode ? const Color(0xFF2A2A2A).withOpacity(0.7) : Colors.white70;
  Color get cardColor24 => isDarkMode ? const Color(0xFF2A2A2A).withOpacity(0.24) : Colors.white24;
}
